...
class RegionOfInterest():
    ...
    def set_windtunnel_size(self, height_extension=300, 
        ...
        elif self._tunnel_size == "dwt":
            
            H, S, I, O = 5, 5, 5, 15

            self._H = dwt.wind_tunel_height - self._radius
            self._S = dwt.wind_tunnel_width/2 - self._radius
            self._I = -dwt.wind_tunnel_start - self._radius
            self._O = O * self._tallest_building_height
